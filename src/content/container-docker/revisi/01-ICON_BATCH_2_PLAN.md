...
### Immediate (Today):
- [ ] **1.1** Parse current icons.json → list all Batch 2 icons
- [ ] **1.1.3** Manual audit: rate accuracy setiap icon
- [ ] **1.2.1** Start research: create source mapping spreadsheet

### Short-term (This Week):
- [ ] **1.2.2 - 1.2.3** Complete source research + licensing check
- [ ] **1.3** Decide workflow: manual vs automated vs hybrid
- [ ] **2.1 - 2.2** Evaluate APIs & scraping tools

### Medium-term (Next Week):
- [ ] **3.1 - 3.4** Execute downloads + processing
- [ ] **4.1 - 4.3** Validation & integration testing
- [ ] **5.1 - 5.2** Database update + documentation
